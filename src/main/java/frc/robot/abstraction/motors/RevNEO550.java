 ...
 */
public class RevNEO550 extends AbstractMotor {
     ...
     */
    public RevNEO550(CANSparkMax motor) {
        // Load motor.
        this.motor = motor;
    ...
    public void configureIntegratedEncoder(double encoderConversionFactor) {
        if (absoluteEncoder == null) {
            ...
            configureCANStatusFrames(10, 20, 20, 550, 550);
        } else {
    ...
    private void configureSparkMax(Supplier<REVLibError> config) {
        ...
        DriverStation.reportWarning("Failure configuring NEO 550 on CAN ID " + motor.getDeviceId(), true);
    }
}
